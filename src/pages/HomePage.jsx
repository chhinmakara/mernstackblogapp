      ...
      <div className="flex items-center justify-center">
        ...
        <div className="">
          ...
          <p className="mt-8 text-md md:text-xl">
            Poluptatibus voluptates optio corporis vero autem? Dignissimos velit
            qui omnis explicabo.
          </p>
        </div>
        {/* animated button */}
        <Link to="publishpost" className="hidden md:block relative">
          <svg
            viewBox="0 0 200 200"
            width={200}
            height={200}
          ...
          <button className="absolute top-0 right-0 bottom-0 left-0 m-auto w-20 h-20 bg-blue-800 rounded-full flex items-center justify-center">
            <svg
              fill="#FFFFFF"
              height="50px"
              width="50px"
              ...
              xmlSpace="preserve"
              stroke="#FFFFFF"
              strokeWidth="11.507007999999999"
